...
import 'package:crowdlift/utils/search_users.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("${widget.query}s", style: GoogleFonts.robotoSlab(color: Colors.white)),
          ...
          children: [
            ...
            Expanded(
              child: isSearching
                  ...
                  ? Center(child: Text("No ${widget.query} found", style: TextStyle(color: Colors.white)))
                  : ListView.builder(
