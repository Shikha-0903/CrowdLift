...
import 'package:crowdlift/users/edit_profile.dart';
...
class _MyProfileState extends State<MyProfile> {
  ...
  Future<void> _fetchUserData() async {
    try {
      ...
      if (uid != null) {
        DocumentSnapshot userDoc = await FirebaseFirestore.instance.collection('crowd_user').doc(uid).get();
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.robotoSlab(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInfoRow(Icons.business, role == "Investor" ? "Capacity" : "About Business", capacityAbout),
                          _buildInfoRow(Icons.favorite, role == "Investor" ? "Interested In" : "Expectations", interestExpect),
                        ],
                      ),
                    ),
                  ),
