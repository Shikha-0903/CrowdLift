...
import 'package:crowdlift/chat/agreement/agreement_screen.dart';
import 'package:crowdlift/chat/payment_gateway.dart';
import 'package:crowdlift/widgets/custom_snack_bar.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:intl/intl.dart';
import '../utils/emoji_pick.dart';
import 'package:file_picker/file_picker.dart';
import 'package:firebase_storage/firebase_storage.dart';
import 'dart:io' as io;
import 'show_inapp.dart';
// Import the notification service
import 'package:crowdlift/utils/notification.dart'; // Update this to your actual path

class ChatScreen extends StatefulWidget {
  final String receiverId;
  final String receiverName;

  const ChatScreen({Key? key, required this.receiverId, required this.receiverName})
      : super(key: key);
...
// Add this property to your _ChatScreenState class
  ...
  Future<void> _pickAndUploadFile() async {
    try {
      ...
      await _firestore.collection('chats').doc(chatId).collection('messages').add(fileMessageData);
  ...
  Future<String> getUserName(String userId) async {
    try {
      DocumentSnapshot userDoc = await _firestore.collection('crowd_user').doc(userId).get();
      if (userDoc.exists) {
          ...
          IconButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          AgreementFormScreen(chatId: chatId, isSeeker: _isSeeker)),
                );
              },
                              ...
                              if (isMe) {
                                ...
                                showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    ...
                                    title: Text("Message Options", style: TextStyle(color: Colors.white)),
                                    content: Column(
                                ...
                                showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                    ...
                                    content: Column(
                                      ...
                                      children: [
                                        ListTile(
                                          leading: Icon(Icons.reply, color: Colors.blueAccent),
                                          title: Text("Reply", style: TextStyle(color: Colors.white)),
                                          onTap: () {
                                            Navigator.pop(context);
                                            setReplyMessage(messageId, msg);
                                          },
                                        ),
                                      ],
                                    ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (msg.containsKey('replyTo') && !isDeleted)
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            FutureBuilder<String>(
                                                future: getUserName(msg['replySenderId']),
                                    ...
                                    if (isDeleted)
                                      Container(
                                        ...
                                        child: Row(
                                          mainAxisSize: MainAxisSize.min,
                                          children: [
                                            Icon(Icons.not_interested, color: Colors.white70, size: 16),
                                            SizedBox(width: 8),
                                            Text(
                                    ...
                                    else if (msg.containsKey('fileUrl') && msg['fileUrl'] != null)
                                      GestureDetector(
                                        onTap: () {
                                          showFileInApp(context, msg['fileUrl'], msg['fileName'] ?? "File");
                                        },
                                        child: Container(
                                          padding: EdgeInsets.all(12),
                                          decoration: BoxDecoration(
                                            color: isMe ? Color(0xFF5E46C1) : Color(0xFFA998F7),
                                            borderRadius: BorderRadius.circular(16),
                                          ),
                                          child: Row(
                                            mainAxisSize: MainAxisSize.min,
