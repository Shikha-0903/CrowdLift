          ...
          PageView(
            ...
            children: [
              _buildPage(
                ...
                description:
                    "Explore a world of opportunities and bring your vision to life!",
                animation: 'assets/animations/create.json',
              ),
              _buildPage(
                title: "Collaborate & Create",
                description:
                    "Join forces with like-minded people and build something amazing!",
                animation: 'assets/animations/build.json',
              ),
              _buildPage(
                title: "Grow & Succeed",
                description:
                    "Turn your passion into success with the support of a strong community!",
