...
import 'package:crowdlift/src/feature/chat/presentation/pages/chat_screen.dart';
import 'package:crowdlift/src/core/utils/phone_call.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildInfoCard("📧 Email", email, isClickable: true,
                onTap: () async {
              final Uri emailUri = Uri(
                scheme: 'mailto',
                path: email,
