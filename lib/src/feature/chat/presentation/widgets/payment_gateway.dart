import 'dart:io';
import 'package:crowdlift/src/feature/transaction/presentation/widgets/generate_receipt.dart';
...
class _PaymentGatewayScreenState extends State<PaymentGatewayScreen> {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    try {
      ...
      // Extract user data
      String senderName =
          userDoc['name'] ?? "Unknown User"; // Assuming name field exists
      ...
      final pdfPath = await _generateReceipt(
          transactionId, amount, receiverName, senderName, transactionDate);
  ...
  Future<String> _generateReceipt(String transactionId, String amount,
      String receiverName, String senderName, String transactionDate) async {
  ...
  void _showShareDialog(String filePath, Map<String, dynamic> transactionData) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            "Your payment receipt has been generated. Would you like to share it?"),
        actions: [
          ...
          _dialogButton("Download", () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    ReceiptScreen(transactionData: transactionData),
              ),
            );
          }),
        ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Payment to ${widget.receiverName}',
