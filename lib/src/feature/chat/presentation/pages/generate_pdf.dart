      ...
      pw.Page(
        ...
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            ...
            _buildSection(
                "Investment Amount", "Rs ${widget.agreement.investmentAmount}"),
            _buildSection("Duration", "${widget.agreement.duration} years"),
            _buildSection("Profit Sharing (Investor)",
                "${widget.agreement.profitSharingI}%"),
            _buildSection("Profit Sharing (Seeker)",
                "${widget.agreement.profitSharingS}%"),
            ...
            pw.Wrap(
              children: [
                pw.Text(widget.agreement.terms, style: _textStyle(fontSize: 14))
              ],
            ),
            pw.SizedBox(height: 200),
            pw.Divider(),
            _buildSection("Seeker Agreement Completed",
                widget.agreement.seekerCompleted ? 'Yes' : 'No'),
            _buildSection("Investor Agreement Completed",
                widget.agreement.investorCompleted ? 'Yes' : 'No'),
            _buildSection("Agreement Locked",
                widget.agreement.agreementLocked ? 'Yes' : 'No',
                isBold: true),
          ],
        ),
      ),
              ...
              : ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    await Printing.sharePdf(
                        ...
                        filename: "agreement_${widget.chatId}.pdf");
                  },
