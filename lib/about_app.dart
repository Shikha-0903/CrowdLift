...
class AboutApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "About CrowdLift",
          style: GoogleFonts.geologica(fontWeight: FontWeight.bold, color: Colors.white),
        ),
      ),
      body: Container(
  ...
  Widget _buildHighlightCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.blue.shade300, blurRadius: 8, spreadRadius: 2)],
      ),
      child: Text(
        ...
        child: AnimatedTextKit(
          animatedTexts: [
            TypewriterAnimatedText(
              ...
              textAlign: TextAlign.center,
              textStyle: GoogleFonts.openSans(fontSize: 16, color: Colors.white),
  ...
  Widget _buildFeatureSection() {
    return Column(
      children: [
        _buildFeatureTile(Icons.business, "Explore Business Profiles", "Discover innovative startups & growing businesses."),
        _buildFeatureTile(Icons.handshake, "Find Investors & Partners", "Connect with investors & mentors who believe in your vision."),
        _buildFeatureTile(Icons.trending_up, "Investment Opportunities", "Support promising ventures and be part of their success."),
        _buildFeatureTile(Icons.security, "Safe & Transparent", "We ensure secure transactions & verified profiles."),
      ],
    );
  }
  ...
  Widget _buildWhyJoinCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        boxShadow: [BoxShadow(color: Colors.green.shade300, blurRadius: 8, spreadRadius: 2)],
      ),
      child: Column(
        children: [
          Text(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            text,
            style: GoogleFonts.openSans(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white),
          ),
        ],
      ),
    );
